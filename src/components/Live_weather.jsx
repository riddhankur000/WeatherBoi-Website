...
export default function Live_weather(props){
    ...
    let [datetime,setdatetime]=react.useState([])
          ...
          let [descrptn,setdescription]=react.useState([])
          let [w_code,setw_code]=react.useState([])
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        //   }
            ...
            setdescription(json2.data.map((x) => {return x.weather.description}));
        ...
        //   }
          console.log(json3.data[0].weather.description);
            ...
            setcode(((json3.data[0].weather.code)));
    ...
    // ,gmt, setclouds, setcode, setdata, setdatetime, setdes, setdescription, setforecast, setgmt, setjson_gmt, setlocation, setprecip, settemps, setw_code, setwind_cdir_full, 
    ...
    return(
        <div className="live_weather">
            <Heading weather_data={weather_data} forecast={forecast} city_name={location.name} date_time={json_gmt.date_time_txt} timezone={json_gmt.timezone} gmt={String(gmt)} des={des} code={code}/>
            ...
            {!swtch?<Today weather_data={weather_data} forecast={forecast} gmt={gmt}/>:<Forecast datetime={datetime} temps={temps} wind_spd={wind_spd} wind_cdir_full={wind_cdir_full} clouds={clouds} precip={precip} descrptn={descrptn} w_code={w_code}/>}
